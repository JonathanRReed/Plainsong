...
const PARAKEET_CTC_06B_V3_MODEL_ID: &str = "parakeet-tdt-0.6b-v3";
...
const PARAKEET_CTC_06B_V3_REPO: &str = "nvidia/parakeet-tdt-0.6b-v3";
...
impl ParakeetProvider {
    ...
    fn repo_id(&self) -> &'static str {
        match self.model_id.as_str() {
            PARAKEET_CTC_06B_V3_MODEL_ID => PARAKEET_CTC_06B_V3_REPO,
            PARAKEET_CTC_06B_MODEL_ID => PARAKEET_CTC_06B_REPO,
            PARAKEET_CTC_11B_MODEL_ID => PARAKEET_CTC_11B_REPO,
            _ => PARAKEET_CTC_06B_V3_REPO,
        }
    }
...
fn normalize_parakeet_model_id(model_id: &str) -> String {
    match model_id.trim() {
        PARAKEET_CTC_06B_V3_MODEL_ID => PARAKEET_CTC_06B_V3_MODEL_ID.to_string(),
        PARAKEET_CTC_06B_MODEL_ID => PARAKEET_CTC_06B_MODEL_ID.to_string(),
        ...
        _ => PARAKEET_CTC_06B_V3_MODEL_ID.to_string(), // Default to v3 for multilingual support
    }
}
...
impl AsrProvider for ParakeetProvider {
    ...
    fn model_info(&self) -> ModelInfo {
        match self.model_id.as_str() {
            ...
            PARAKEET_CTC_06B_V3_MODEL_ID => ModelInfo {
