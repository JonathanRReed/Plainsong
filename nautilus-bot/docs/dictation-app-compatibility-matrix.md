...
| --- | --- | --- | --- | --- |
| Apple Notes | PARTIAL | auto | REQUIRED | Packaged insertion verified in `release/qa/app-matrix-insertion-apple-notes.md`. In a brand-new empty note, click the body once to establish the insertion caret before dictating. |
| Google Docs (Chrome) | SUPPORTED | auto | REQUIRED | Packaged insertion verified in `release/qa/app-matrix-insertion-google-docs-chrome.md`. |
| Slack | SUPPORTED | auto | REQUIRED | Packaged insertion verified in `release/qa/app-matrix-insertion-slack.md`. |
...
| Messages | SUPPORTED | auto | REQUIRED | Packaged insertion verified in `release/qa/app-matrix-insertion-messages.md`. |
