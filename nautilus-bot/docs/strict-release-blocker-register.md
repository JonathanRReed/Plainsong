...
| BR-002 | CP benchmark gate artifacts missing (`docs/evals/benchmark-run-baseline.json`, `docs/evals/benchmark-run-latest-macos.json`, `docs/evals/benchmark-run-latest-windows.json`) | High | `artifacts/benchmark-gates-macos.blocked.md`, `artifacts/benchmark-gates-windows.blocked.md` | Produce benchmark run JSON artifacts and re-run `scripts/verify-benchmark-gates.mjs` for macOS and Windows. |
