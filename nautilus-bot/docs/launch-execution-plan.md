...
| LX-04 | P0 | Execute packaged QA matrix | Launch proof is still partial. Current matrix is `21 PASS / 31 BLOCKED / 0 PENDING`; macOS is `21 PASS / 6 BLOCKED / 0 PENDING`; Windows is `0 PASS / 25 BLOCKED / 0 PENDING`. | QA | L | LX-03 | Required matrix rows move from `BLOCKED` to executed `PASS` or documented `FAIL` with defect IDs. |
